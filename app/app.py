...
# Supervisor credentials list — edit as needed
USERS = {
    "supervisor1": {"password": "shift2026",  "name": "Alex Rivera",    "role": "Floor Supervisor"},
    "supervisor2": {"password": "factory99",  "name": "Maria Santos",   "role": "Senior Supervisor"},
    "admin":       {"password": "admin1234",  "name": "Pariket Koirala","role": "Admin"},
}
...
def login_page():
    ...
    with col_c:
        ...
        st.caption("Demo credentials — supervisor1 / shift2026")
...
with tab4:
    ...
    # ── 1. Productivity by Day & Department ──────────────────
    ...
    CORR_COLS = [
        prod_col, 'targeted_productivity', 'smv', 'wip',
    ...
    # ── 3. Productivity by Quarter & Department ───────────────
    ...
    # ── 4. Idle Time & Overtime Patterns by Day ───────────────
    st.markdown("### Idle Time & Overtime Patterns by Day")
    st.caption(
        "Normalized average idle time and overtime per day. "
        "High idle time on certain days can signal scheduling inefficiencies."
    )
...
ENDOFFILEcat > app/app.py << 'ENDOFFILE'
# ============================================================
#  Worker Productivity Dashboard — Phase 5
#  Added: Session-based login + Heatmaps tab
# ============================================================
